...
public:
    ...
    dynet::real GetAttLatTemperature(){ return attentional_lat_temperature_; }
    bool GetUpdateAttLatTemperature(){ return update_attentional_lat_temperature_; }
...
protected:
    ...
    // Current sentence;
    std::vector<Sentence> const * cur_sentence_multi_;
    std::vector<Sentence> cur_sentence_single_;
    std::vector<Sentence> const * cur_sentence_;
    dynet::real attentional_lat_temperature_;
    bool update_attentional_lat_temperature_;
    ...
    dynet::Parameter p_att_lat_temp_;
    ...
    dynet::expr::Expression i_att_lat_temp_;
