...
Sentence ParseAsWords(dynet::Dict & dict, const std::string & str, bool sent_end, std::string file_type="txt");
Sentence ParseAsLattice(dynet::Dict & dict, const std::string & str, std::string file_type);
Sentence ParseAsFeatures(const std::string & str, std::string file_type);
