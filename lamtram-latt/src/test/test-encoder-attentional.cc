...
struct TestEncoderAttentional {
  ...
  void CreateModel(
    ...
    ExternAttentionalPtr ext(new ExternAttentional(encs, attention_type, attention_hist, 5, my_lex_type, vocab_src_, vocab_trg_, *mod, false, 0.0));
...
BOOST_AUTO_TEST_CASE(TestWriteRead) {
  ...
  ExternAttentionalPtr exp_ext(new ExternAttentional(exp_encs, "mlp:2", "none", 3, "none", vocab_src_, vocab_trg_, *exp_mod, false, 0.0));
