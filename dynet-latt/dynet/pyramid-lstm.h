#ifndef DYNET_PYRAMID_LSTM_H_
#define DYNET_PYRAMID_LSTM_H_
...
struct PyramidLSTMBuilder : public RNNBuilder {
  PyramidLSTMBuilder() = default;
  explicit PyramidLSTMBuilder(unsigned layers,
                       unsigned input_dim,
                       unsigned hidden_dim,
                       Model* model);
  ...
  unsigned pyramid_height(unsigned t);
  unsigned num_outputs_for_inputs(unsigned input_len);
